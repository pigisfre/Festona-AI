...
manager.addDocument('it', 'A che ora è la festa?', 'party.date');
...
manager.addDocument('it', 'Ci si traveste?', 'party.dressCode');
...
manager.addAnswer('it', 'party.date', 'La festa sarà il 20 dicembre alle ore 21:30.');
