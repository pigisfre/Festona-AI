...
const Chatbot = () => {
  ...
  const handleStartChatbot = () => {
    setShowForm(true);
    const welcomeMessage = "Ciao a tutti, io sono FESTONA,l'assistente vocale ufficiale del party. Sono qui per rispondere a tutte le tue domande sulla festa e per divertirci insieme!";
